...
load_from_disk = True
if load_from_disk:
    penval = np.load('D:\pds_project\penval.npy')
...
pen_img = cv2.resize(cv2.imread('D:\pds_project\pen.png',1), (50, 50))
eraser_img = cv2.resize(cv2.imread('D:\pds_project\eraser.jpg',1), (50, 50))
